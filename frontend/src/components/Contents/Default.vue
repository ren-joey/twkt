...
export default {
    ...
    methods: {
        login() {
            if (this.fetching.login === 'Y') return;
            if (this.$refs.form.validate()) {
                this.fetching.login = 'Y';

                if (this.userInput.rememberMe === true) localStorage.setItem('email', this.userInput.email);
                ...
                axios.get('api/login/', {
                    ...
                    this.fetching.login = 'N';
                    this.actionSetInitData(res.data);

                    if (res.data.is_login === 'N') {
